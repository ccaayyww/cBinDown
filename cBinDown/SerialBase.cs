...
namespace cBinDown
{
    public class SerialBase
    {
        ...
        public SerialBase()
        {
            ...
            hybirdLock = new cSimpleHybirdLock();
        }
        ...
        {
            SP_ReadData.ReadTimeout = 1000;
            SP_ReadData.WriteTimeout = 1000;
            SP_ReadData.RtsEnable = false;
            SP_ReadData.DtrEnable = false;
            SP_ReadData.BreakState = false;
            SP_ReadData.Handshake = Handshake.None;            
        ...
        private cSimpleHybirdLock hybirdLock;                      // 数据交互的锁
